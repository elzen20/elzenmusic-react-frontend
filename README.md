...
- REACT_APP_SPOTIFY_REDIRECT_URI=`<REACT_APP_SPOTIFY_REDIRECT_URI>` (optional, defaults to current page URL)
...
# Firebase changing environment for deployment

### `firebase use dev or alias name.`